...
public class AdvancedSlabs extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		if (Minecraft.VERSION.olderThan(Minecraft.Version.v1_17_R1)) {
			getLogger().log(Level.WARNING, "This version of the plugin is intended to be used with 1.17+! Please use a version older than 1.9.0 for older MC versions.");
		}
