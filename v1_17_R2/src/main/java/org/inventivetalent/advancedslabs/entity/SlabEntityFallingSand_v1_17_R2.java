...
public class SlabEntityFallingSand_v1_17_R2 extends EntityFallingBlock implements ISlabFallingBlock {

    private boolean canDie = false;

    public SlabEntityFallingSand_v1_17_R2(World world) {
        super(EntityTypes.C, world);
    }

    public SlabEntityFallingSand_v1_17_R2(World world, double d0, double d1, double d2, IBlockData iblockdata) {
